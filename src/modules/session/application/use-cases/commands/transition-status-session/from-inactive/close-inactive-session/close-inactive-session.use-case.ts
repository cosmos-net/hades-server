...
@Injectable()
@CommandHandler(CloseInactiveSessionCommand)
export class CloseInactiveSessionUseCase implements ICommandHandler<CloseInactiveSessionCommand> {
  constructor(
  ...
  async execute(command: CloseInactiveSessionCommand): Promise<SessionModel> {
