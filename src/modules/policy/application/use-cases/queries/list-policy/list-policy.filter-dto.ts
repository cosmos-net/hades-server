...
import { IParamsListPolicyQuery } from '@policy/application/use-cases/queries/list-policy/list-policy.query';

export class ListPolicyFilter {
  static toFilterMap(query: IParamsListPolicyQuery): Array<Map<string, PrimitivesType>> {
