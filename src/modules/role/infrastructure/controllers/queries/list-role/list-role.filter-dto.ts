...
export class ListRoleFilter {
  static toFilterMap(dto: ListRoleInputDto): Array<Map<string, PrimitivesType>> {
    ...
    addFilter(filtersMapper, 'name', dto.name, OperatorsEnum.ILIKE);
